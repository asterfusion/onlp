...
typedef enum thermal_id_e {
    THERMAL_ID_MAIN_BOARD_LEFT = 1,
    THERMAL_ID_MAIN_BOARD_RIGHT = 2,
    THERMAL_ID_FAN1 = 3,
    THERMAL_ID_GHC1_JUNCTION = 4,
    THERMAL_ID_GHC1_AMBIENT = 5,
    THERMAL_ID_GHC2_JUNCTION = 6,
    THERMAL_ID_GHC2_AMBIENT = 7,
    THERMAL_ID_BF_JUNCTION = 8,
    THERMAL_ID_BF_AMBIENT = 9,
    THERMAL_ID_FAN2 = 10,
...
typedef enum thermal_oid_e {
    THERMAL_OID_MAIN_BOARD_LEFT     = ONLP_THERMAL_ID_CREATE(THERMAL_ID_MAIN_BOARD_LEFT),
    THERMAL_OID_MAIN_BOARD_RIGHT    = ONLP_THERMAL_ID_CREATE(THERMAL_ID_MAIN_BOARD_RIGHT),
